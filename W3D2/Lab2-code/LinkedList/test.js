...
describe("LinkedList", function () {
    ...
    describe("sort() method", function () {
        it("checks if the list contains an element", function () {
            linkedList.add(4);
            linkedList.add(2);
            linkedList.sort((a,b) => {if (a < b) {
                return -1;
            } else if (a > b) {
                return 1
            }
            ...
            assert.equal(linkedList.get(0), 2);
            assert.equal(linkedList.get(1), 4);
        });
    });
    describe("contains() method", function () {
        it("checks if the list contains an element", function () {
            linkedList.add(1);
            linkedList.add(2);
            assert.equal(linkedList.contains(1), true);
            assert.equal(linkedList.contains(2), true);
        });
    });
});