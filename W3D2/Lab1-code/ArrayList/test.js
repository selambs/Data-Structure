...
describe("ArrayList", function () {
    ...
    describe("contains() method", function () {
        it("search a number element using contains function", function () {
            arrayList.add(1);
            arrayList.add(5);
            arrayList.add(3);
            arrayList.sort((a, b) => { return a - b });
            assert.equal(arrayList.contains(0), -1);
            assert.equal(arrayList.contains(1), 0);
            assert.equal(arrayList.contains(3), 1);
            assert.equal(arrayList.contains(5), 2);

        });

        it("search a string element using contains function", function () {
            arrayList.add("big");
            arrayList.add("small");
            arrayList.add("tall");
            arrayList.add("round");
            ...
            assert.equal(arrayList.contains("tiny"), 11);
            assert.equal(arrayList.contains("square"), 9);
            assert.equal(arrayList.contains("vast"), 12);
